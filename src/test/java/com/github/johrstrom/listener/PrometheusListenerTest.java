        ...
        for (ListenerCollectorConfig cfg : configs) {
            ...
            switch (name) {
                ...
                case "test_hist_rtime":
                    assertOnHistogram(reg.getOrCreateAndRegister(cfg), elapsedTime * samplesOccurred, samplesOccurred, elapsedTime);
                    break;
                case "test_hist_rsize":
                    assertOnHistogram(reg.getOrCreateAndRegister(cfg), responseSize * samplesOccurred, samplesOccurred, responseSize);
                    break;
                ...
                case "test_hist_idle_time":
                    assertOnHistogram(reg.getOrCreateAndRegister(cfg), idleTime * samplesOccurred, samplesOccurred, idleTime);
                    break;
                case "test_hist_connect_time":
                    assertOnHistogram(reg.getOrCreateAndRegister(cfg), connectTime * samplesOccurred, samplesOccurred, connectTime);
                    break;

                // summaries
                case "test_summary_rtime":
                    assertOnSummary(reg.getOrCreateAndRegister(cfg), elapsedTime * samplesOccurred, samplesOccurred, elapsedTime);
                    break;
                case "test_summary_rsize":
                    assertOnSummary(reg.getOrCreateAndRegister(cfg), responseSize * samplesOccurred, samplesOccurred, responseSize);
                    break;
                ...
                case "test_summary_connect_time":
                    assertOnSummary(reg.getOrCreateAndRegister(cfg), connectTime * samplesOccurred, samplesOccurred, connectTime);
                    break;
